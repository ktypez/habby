...
export const ACHIEVEMENTS = [
  { id: 'first', name: 'First Blood', desc: 'Complete your first task', emoji: '🩸' },
  { id: 'ten', name: 'Double Digits', desc: 'Complete 10 tasks', emoji: '🔟' },
  { id: 'twenty-five', name: 'Task Slayer', desc: 'Complete 25 tasks', emoji: '⚔️' },
  { id: 'fifty', name: 'Half Century', desc: 'Complete 50 tasks', emoji: '💯' },
  { id: 'level5', name: 'Rising Star', desc: 'Reach Level 5', emoji: '⭐' },
  { id: 'level10', name: 'Legend', desc: 'Reach Level 10', emoji: '👑' },
  { id: 'streak3', name: 'Warm Up', desc: 'Hit a 3-day streak', emoji: '🔥' },
  { id: 'streak7', name: 'On Fire', desc: 'Hit a 7-day streak', emoji: '🌋' },
  { id: 'streak30', name: 'Unstoppable', desc: 'Hit a 30-day streak', emoji: '🏆' },
  { id: 'weekgoal', name: 'Weekly Warrior', desc: `Hit the weekly goal (${WEEK_GOAL} tasks in 7 days)`, emoji: '🎖️' },
  { id: 'perfect', name: 'Perfect Day', desc: 'Complete every due task on time', emoji: '✨' }
]
